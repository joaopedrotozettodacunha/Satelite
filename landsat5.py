...
reference_date = '2009-01-20'  # Data de referência
...
### Análise com LANDSAT/LT05/C02/T1_L2

sensor_name = "LANDSAT/LT05/C02/T1_L2"
...
if image_count == 0:
    ...
    base_collection = ee.ImageCollection('LANDSAT/LT05/C02/T1_L2') \
        .filterBounds(geometry) \
